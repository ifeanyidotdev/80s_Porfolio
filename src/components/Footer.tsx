...
import { FOOTER_COPYRIGHT, SOCIAL_LINKS } from "../utils/constant";
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex flex-col md:flex-row justify-between items-center">
					<div className="mb-6 md:mb-0">
						<a
							href="#home"
							className="cursive-font text-3xl font-bold text-white hover:text-purple-400 transition-colors animate-glow"
						>
							Ifeanyi
						</a>
					</div>
				...
				<div className="mt-8 pt-8 border-t border-purple-900/30 text-center">
					<p className="text-gray-400">&copy; {FOOTER_COPYRIGHT}</p>
