...
import { Github, Linkedin, Mail, ChevronDown, X } from "lucide-react";
    ...
    >
      <div className="section-container">
        <div className="text-center">
          <h2 className="text-2xl md:text-3xl mb-4 opacity-80 monospace-font">
            Hello, I am
          </h2>
          <h1 className="text-5xl md:text-7xl lg:text-8xl mb-8 cursive-font animate-glow">
            Ifeanyichukwu Sampson
          </h1>
          <div className="h-12 mb-12">
            <h3
              ref={textRef}
              className="text-2xl md:text-4xl monospace-font text-purple-300"
            >
              &nbsp;
            </h3>
          </div>
